namespace UglyToad.MakeMe.Tests
{
    ...
    public class PostalCodeMakerTests
    {
        ...
        {
            var codes = MakeFactory.Make(A.PostalCode().FromUnitedKingdom(), 52).GenerateSeries(500)
                .ToList();
        ...
        {
            var codes = MakeFactory.Make(A.PostalCode().FromUnitedKingdom().IncludeInvalid(10), 25).GenerateSeries(100);
        ...
        {
            var codes = MakeFactory.Make(A.PostalCode()).GenerateSeries(250);
